...
namespace EMRSimulation.Infrastructure.Repositories
{
    public partial class PatientRepository : IPatientRepository
    {
        ...
        public async Task<int> AddFluidBalanceChartAsync(FluidBalanceChartDto dto)
        {
            ...
            command.Parameters.Add(new SqlParameter("@LabId", dto.LabId ?? (object)DBNull.Value));
            command.Parameters.Add(new SqlParameter("@PatientId", dto.PatientId ?? (object)DBNull.Value));
            command.Parameters.Add(new SqlParameter("@ChartDate", dto.ChartDate));
            command.Parameters.Add(new SqlParameter("@ChartTime", string.IsNullOrEmpty(dto.ChartTime) ? (object)DBNull.Value : dto.ChartTime));
        ...
        public async Task<FluidBalanceChartDto?> GetFluidBalanceChartByIdAsync(int id, int labId)
        {
            ...
            // First result set: the chart header
            ...
            // Second result set: child entries
        ...
        private static FluidBalanceChartDto MapFluidBalanceChart(SqlDataReader r)
        {
            return new FluidBalanceChartDto
            {
                ...
                ChartTime = r.IsDBNull(r.GetOrdinal("ChartTime")) ? null : r.GetTimeSpan(r.GetOrdinal("ChartTime")).ToString(@"hh\:mm"),
                ...
                EarliestEntryDate = HasColumn(r, "EarliestEntryDate") && !r.IsDBNull(r.GetOrdinal("EarliestEntryDate")) ? r.GetDateTime(r.GetOrdinal("EarliestEntryDate")) : r.GetDateTime(r.GetOrdinal("ChartDate")),
                LatestEntryDate   = HasColumn(r, "LatestEntryDate")   && !r.IsDBNull(r.GetOrdinal("LatestEntryDate"))   ? r.GetDateTime(r.GetOrdinal("LatestEntryDate"))   : r.GetDateTime(r.GetOrdinal("ChartDate")),
            };
        }
        ...
        public async Task<int> AddFluidBalanceChartEntryAsync(FluidBalanceChartEntryDto dto)
        {
            ...
            using (var command = (SqlCommand)connection.CreateCommand())
            {
                ...
                command.Parameters.Add(new SqlParameter("@EntryDate",           dto.EntryDate == default ? DateTime.Today : dto.EntryDate));
                ...
                command.Parameters.Add(new SqlParameter("@Initials",  (object)dto.Initials ?? DBNull.Value));

                var scalar = await command.ExecuteScalarAsync();
#pragma warning disable CS8605
                return scalar == null || scalar == DBNull.Value ? 0 : (int)scalar;
#pragma warning restore CS8605
        ...
        public async Task<IEnumerable<FluidBalanceChartEntryDto>> GetFluidBalanceChartEntriesAsync(int fluidBalanceChartId)
        {
            ...
            using (var command = (SqlCommand)connection.CreateCommand())
            {
                ...
                using (var reader = await command.ExecuteReaderAsync())
                    while (await reader.ReadAsync())
                        list.Add(new FluidBalanceChartEntryDto
                        {
                            Id                  = reader.GetInt32(reader.GetOrdinal("Id")),
                            FluidBalanceChartId = reader.GetInt32(reader.GetOrdinal("FluidBalanceChartId")),
                            EntryDate           = reader.IsDBNull(reader.GetOrdinal("EntryDate")) ? DateTime.Today : reader.GetDateTime(reader.GetOrdinal("EntryDate")),
                EntryTime           = reader.GetString(reader.GetOrdinal("EntryTime")),
                Initials            = reader.IsDBNull(reader.GetOrdinal("Initials")) ? null : reader.GetString(reader.GetOrdinal("Initials")),
                            ...
                            AmountMl            = reader.GetInt32(reader.GetOrdinal("AmountMl")),
        ...
        public async Task<int> GetLatestFluidBalanceTotalBalanceAsync(int labId, int patientId, DateTime? beforeDate = null)
        {
            using (var connection = await _dbConnectionFactory.CreateAsync())
            using (var command    = (SqlCommand)connection.CreateCommand())
            {
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "GetLatestFluidBalanceTotalBalance";
                command.Parameters.Add(new SqlParameter("@LabId",      labId));
                command.Parameters.Add(new SqlParameter("@PatientId",  patientId));
                command.Parameters.Add(new SqlParameter("@BeforeDate", beforeDate.HasValue ? (object)beforeDate.Value : DBNull.Value));
                var scalar = await command.ExecuteScalarAsync();
#pragma warning disable CS8605
                return scalar == null || scalar == DBNull.Value ? 0 : (int)scalar;
#pragma warning restore CS8605
...
#pragma warning restore CS8605
        ...
        // Stub - satisfies IPatientRepository.AddIvFluidChartsync
